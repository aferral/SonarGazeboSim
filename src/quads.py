...
#CODE FROM https://github.com/fogleman/Quads/blob/master/main.py
#CODE FROM https://github.com/fogleman/Quads/blob/master/main.py
#CODE FROM https://github.com/fogleman/Quads/blob/master/main.py
#CODE FROM https://github.com/fogleman/Quads/blob/master/main.py
#CODE FROM https://github.com/fogleman/Quads/blob/master/main.py

#To threshold to binary image
th = 5
...
class Model(object):
    ...
    def render(self, path, max_depth=None):
        ...
        with open('out.rec','w+') as f:
            ...
            print "There are ",len(self.root.get_leaf_nodes(max_depth))," QUADS"
            for quad in self.root.get_leaf_nodes(max_depth):
                l, t, r, b = quad.box


                print "Quad ",quad.box," color ",quad.color
                ...
                if quad.color[0] > th:
                    ...
                    y0 = t
                    ly = b-t
                    f.write(str(x0)+" -60 "+str(y0)+" "+str(lx)+" 120 "+str(ly)+"\n")
...
if __name__ == '__main__':
    image = Image.open("out.jpg").convert('RGB')
    main(image)